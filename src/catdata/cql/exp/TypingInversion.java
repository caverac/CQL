...
public class TypingInversion implements ExpCoVisitor<AqlTyping, Unit, RuntimeException> {
  ...
  // Documentation-only prototype: SchExpDiff is dispatched via visitSchExpPrefix in
  // coaccept, so it has no interface method; AqlHelp reaches it reflectively by name.
  public SchExpDiff visitSchExpDiff(Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
    exp.defs.tys.put("t", Unit.unit);
  ...
  public SchExpColim visitSchExpColim(Unit params, AqlTyping exp) {
    ...
    ColimSchExpQuotient q =
        new ColimSchExpQuotient(
            t,
            Collections.emptyList(),
            Collections.emptyList(),
            Collections.emptyList(),
  ...
  public MapExpRaw visitMapExpRaw(Unit params, AqlTyping exp) {
    ...
    SchExp s2 = new SchExpVar("s2");
    //    exp.defs.maps.put("m", new Pair(s1, s2));
    return new MapExpRaw(
        s1, s2, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
  }
  ...
  public MapExpColim visitMapExpColim(Unit params, AqlTyping exp) {
    ...
    ColimSchExpQuotient q =
        new ColimSchExpQuotient(
            t,
            Collections.singletonList(new LocStr(0, "s")),
            Collections.emptyList(),
            Collections.emptyList(),
            Collections.emptyList(),
            Collections.emptyList());
  ...
  @Override
  public <Gen1, Sk1, X1, Y1, Gen2, Sk2, X2, Y2>
      PragmaExpToJdbcTrans<Gen1, Sk1, X1, Y1, Gen2, Sk2, X2, Y2> visitPragmaExpToJdbcTrans(
    ...
    TransExp<Object, Object, Object, Object, Object, Object, Object, Object> h =
        new TransExpVar("h");
  ...
  @Override
  public <Gen1, Sk1, X1, Y1, Gen2, Sk2, X2, Y2>
      PragmaExpToCsvTrans<Gen1, Sk1, X1, Y1, Gen2, Sk2, X2, Y2> visitPragmaExpToCsvTrans(
          Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp<Object, Object, Object, Object> i1 = new InstExpVar("i1");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      InstExpCoEq<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitInstExpCoEq(
          Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
  ...
  public <Gen, Sk, X, Y> InstExpColim<Gen, Sk, X, Y> visitInstExpColim(Unit param, AqlTyping exp) {
    ...
    SchExp s = new SchExpVar("s");
    exp.defs.tys.put("t", Unit.unit);
    return new InstExpColim(
        g, s, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
  }
  ...
  // Documentation-only prototype: InstExpInclude has no interface visit method;
  // AqlHelp reaches it reflectively by name to render its syntax page.
  public <Gen, Sk, X, Y> InstExpInclude<Gen, Sk, X, Y> visitInstExpInclude(
      Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i = new InstExpVar("i");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      InstExpDom<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitInstExpDom(Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i1 = new InstExpVar("i1");
    InstExp i2 = new InstExpVar("i2");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      InstExpCod<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitInstExpCod(Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i1 = new InstExpVar("i1");
    InstExp i2 = new InstExpVar("i2");
  ...
  @Override
  public <Gen, Sk, X, Y> InstExpQueryQuotient<Gen, Sk, X, Y> visitInstExpQueryQuotient(
      Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i = new InstExpVar("i");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpEval<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpEval(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpCoEval<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpCoEval(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2, Gen3, Sk3, X3, Y3>
      TransExpCompose<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2, Gen3, Sk3, X3, Y3> visitTransExpCompose(
          Unit params, AqlTyping exp) {
    exp.defs.tys.put("t", Unit.unit);
    TyExpVar t = new TyExpVar("t");
    exp.prog.exps.put("t", new TyExpEmpty());
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpDelta<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpDelta(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpSigma<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpSigma(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpPi<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpPi(Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
    InstExp j = new InstExpVar("j");
  ...
  @Override
  public <X1, Y1, X2, Y2> TransExpJdbc<X1, Y1, X2, Y2> visitTransExpJdbc(
      Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i1 = new InstExpVar("i1");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpDistinct<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpDistinct(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpLit<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpLit(
          Unit params, AqlTyping exp) {
    return null;
  }
  ...
  @Override
  public <Gen, Sk, X, Y, Gen1, Gen2, Sk1, Sk2, X1, X2>
      TransExpDiff<Gen, Sk, X, Y, Gen1, Gen2, Sk1, Sk2, X1, X2> visitTransExpDiff(
          Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i = new InstExpVar("i");
  ...
  public TransExpFrozen visitTransExpFrozen(Unit params, AqlTyping exp) {
    ...
    QueryExpVar q = new QueryExpVar("q");
    exp.defs.qs.put("q", new Pair(s1, s2));
    return new TransExpFrozen(
        q, "var", "entity", new RawTerm("term", Collections.emptyList()), "entity_or_type");
  }
  ...
  public QueryExpFromEds visitQueryExpFromEds(Unit params, AqlTyping exp) {
    ...
    exp.defs.eds.put(
        "eds",
        new SchExpVar("s")); // , Collections.emptyList(), Collections.emptyList(), Unit.unit));
  ...
  public ApgTransExpRaw visitApgTransExpRaw(Unit params, AqlTyping r) {
    ...
    return new ApgTransExpRaw(
        G1, G2, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
  }
  ...
  @Override
  public <X, Y> PragmaExpJsonInstExport<X, Y> visitPragmaExpJsonInstExport(
      Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp<String, String, X, Y> i = (InstExp<String, String, X, Y>) (Object) new InstExpVar("i");
  ...
  @Override
  public <X, Y> PragmaExpRdfInstExport<X, Y> visitPragmaExpRdfInstExport(
      Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp<String, String, X, Y> i = (InstExp<String, String, X, Y>) (Object) new InstExpVar("i");
  ...
  @Override
  public <X, Y> PragmaExpRdfDirectExport<X, Y> visitPragmaExpRdfDirectExport(
      Unit params, AqlTyping exp) {
    SchExp s = InstExpRdfAll.makeSch();
  ...
  public InstExpJdbcDirect visitInstExpJdbcDirect(Unit param, AqlTyping exp) {
    return new InstExpJdbcDirect(
        new SchExpEmpty(new TyExpEmpty()),
        Collections.emptyList(),
        "jdbcString",
        "ROW_NUMBER() OVER()");
  }
  ...
  public QueryExpMapToSpanQuery visitQueryExpMapToSpanQuery(Unit params, AqlTyping exp) {
    ...
    return new QueryExpMapToSpanQuery(
        new MapExpRaw(
            s, s2, Collections.emptyList(), Collections.emptyList(), Collections.emptyList()));
  }
  ...
  // Documentation-only prototype: EdsExpAll has no interface visit method;
  // AqlHelp reaches it reflectively by name to render its syntax page.
  public <Gen, Sk, X, Y> EdsExpAll<Gen, Sk, X, Y> visitEdsExpAll(Unit params, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i = new InstExpVar("i");
    exp.defs.tys.put("t", Unit.unit);
  ...
  @Override
  public PragmaExpTinkerpopInstExport visitPragmaExpTinkerpopInstExport(
      Unit params, AqlTyping exp) {
    SchExpVar e = new SchExpVar("s");
    TyExpVar x = new TyExpVar("t");
    InstExpVar i = new InstExpVar("i");
  ...
  public EdsExpSigma visitEdsExpSigma(Unit params, AqlTyping exp) {
    ...
    exp.prog.exps.put("t", new TyExpEmpty());
    exp.prog.exps.put(
        "c", new EdsExpRaw(s1, Collections.emptyList(), Collections.emptyList(), Unit.unit));
  ...
  @Override
  public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2>
      TransExpSubseteq<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> visitTransExpSubseteq(
          Unit params, AqlTyping exp) {
    SchExp s1 = new SchExpVar("s1");
    SchExp s2 = new SchExpVar("s2");
    TyExp t = new TyExpVar("t");
  ...
  @Override
  public <Gen, Sk, X, Y> InstExpCore<Gen, Sk, X, Y> visitInstExpCore(Unit param, AqlTyping exp) {
    SchExp s = new SchExpVar("s");
    TyExp t = new TyExpVar("t");
    InstExp i = new InstExpVar("i");
    exp.defs.schs.put("s", t);
    exp.defs.tys.put("t", Unit.unit);
    exp.defs.insts.put("i", s);
    return new InstExpCore(i);
  }

  @Override
  public EdsExpInfer visitEdsExpInfer(Unit params, AqlTyping exp) {
    TyExp t = new TyExpVar("t");
    SchExp s = new SchExpVar("s");
    EdsExp c1 = new EdsExpVar("c1");
    EdsExp c2 = new EdsExpVar("c2");
    exp.defs.tys.put("t", Unit.unit);
    exp.defs.schs.put("s", t);
    exp.defs.eds.put("c1", s);
    exp.defs.eds.put("c2", s);
    return new EdsExpInfer(c1, c2, s, Collections.emptyList());
  }
}
